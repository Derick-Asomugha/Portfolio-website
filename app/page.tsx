    ...
    <section id="about" className="gap-4 grid grid-cols-1 px-10 lg:grid-cols-2 pt-20 md:pt-40 pb-20 justify-center items-start w-full place-items-center dark:text-white">
      ...
      <div className="pt-20 md:pt-0  px-5 sm:mb-5">
        ...
        <div className="mt-5 place-items-center justify-center text-center">
          <a href="/resume">
           <button className="flex gap-3 md:w-auto w-full  px-6 py-2 rounded-lg font-semibold hover:bg-slate-200 dark:hover:bg-slate-800 text-black dark:text-white border-2 border-black dark:border-white">
